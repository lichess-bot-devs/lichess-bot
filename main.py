...
def start(token, game_id, engine, weights=None):
    # init
...
if __name__ == "__main__":
    ...
    parser.add_argument('gameid', type=str, help='Lichess Game Id')
    parser.add_argument('engine', type=str, help='path to engine binary')
    parser.add_argument('--weights', type=str, help='path to training data (weights) file')
    args = parser.parse_args()

    start(args.token, args.gameid, args.engine, args.weights)
